	...
	public class Seeker : VersionedMonoBehaviour {
		...
		void OnPathComplete (Path p, bool runModifiers, bool sendCallbacks) {
			...
			if (sendCallbacks) {
                ...
                if (debugPathRunning)
                {
                    Debug.Log("Doing path complete by: " + transform.parent.name);
                }
            }
		}
		...
		void StartPathInternal (Path p, OnPathDelegate callback) {
            ...
            if (debugPathRunning)
            {
                Debug.Log("Doing path running by: " + transform.parent.name);
            }
        }
		...
		public void OnDrawGizmos () {
            ...
            //if (debugPathRunning)
            //{
            //    Debug.Log("Doing path drawing gizmos 1 by: " + transform.parent.name);
            //}
            ...
            //if (debugPathRunning)
            //{
            //    Debug.Log("Doing path drawing gizmos 2 by: " + transform.parent.name);
            //}
            ...
            //if (debugPathRunning)
            //{
            //    Debug.Log("Doing path drawing gizmos 3 by: " + transform.parent.name);
            //}
        }
	}
}
